...
## Инкремент разведки 03.09 (не ломает заморозку)

- Считать отдельно ячейку BTC **≥2021-01**; pre-2021 не пулить с ней (sr1052: ортогональность на смешанном окне).
- Только first-print vs prior (MN-4). Ревизии — не подмена actual.
- Карту hawkish→BTC down **не** замораживать на этом прогоне. Сдать mean r по bucket, плюс MN-6 drift vs fade.
- Band ±20k не крутить.
