...
Обзор blobов на `main` на 2026-09-01. Не канон. Не PREF. Не Foundation.
Новые пакеты Grok кладутся только в `from-grok/`. Исторические пути не переносились.

Статусы: **архив** / **кандидат** / **сверка** / **диагностика** / **источник Владельца** / **живой runbook**.
...
| `from-claude/README.md` | Метка: пишет только Claude; штаб больше не пишет | архив |
| `from-chatgpt/README.md` | Метка: пишет только ChatGPT (предпочтения); штаб больше не пишет | архив |
| `from-owner/README.md` | Метка: пишет только Владелец; слово выше заданий Claude | архив |
| `from-grok/INDEX.md` | Этот обзор поля (полный список файлов) | архив |
| `from-grok/PROVENANCE.md` | Провенанс задним числом | архив |
