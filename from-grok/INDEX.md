...
Обзор blobов на `main` на 2026-09-03. Коммит среза: после пакета макро-сценария (этот коммит). Не канон. Не PREF. Не Foundation.
...
N = **128** (все blobы `main` кроме `.gitignore`, включая этот INDEX и PROVENANCE).
...
| `from-grok/2026-09-03-listing-layer.md` | Листинги: настроение до, факт после. Не live | живой runbook |
...
| путь | суть | статус |
|---|---|---|
| `from-grok/patterns/2026-09-03-s1.md` | S1 XOR ZZ vs flat на одном C | кандидат |
| `from-grok/patterns/2026-09-03-s1-replay.md` | S1: union n=3794 WR 40.93%, конфликтов 0 | диагностика |
| `from-grok/patterns/2026-09-03-h1.md` | H1: \|A\|≥1.0% close C (дыра #3) | кандидат |
| `from-grok/patterns/2026-09-03-h1-replay.md` | H1-P1: n=1342 WR 40.98% ≈ P1 | диагностика |
| `from-grok/patterns/2026-09-03-dnevnik.md` | Дневник 03.09: S1 10:00 + H1 14:00 | диагностика |
| `from-grok/crowd/2026-09-03.md` | Толпа: ожидание 10:00 + факт 14:00 | диагностика |
| `from-grok/demo/2026-09-03-lenta.md` | Демо-лента 03.09 (если есть в репо) | диагностика |
...
| `from-grok/2026-09-04-linkages-mechanisms.md` | LNK-RCORR…GRAPH-LAG + OSS лицензии. Не вход | кандидат |
| `from-grok/2026-09-04-linkages-open-sources.md` | LINK-01…22: statsmodels/FF/GLEIF/ICIO/Farside. Не вход | кандидат |
...
- [2026-09-05 Trevs Agents KC Разведчик](../razvedka/novinki/2026-09-05-trevsagents-provenance.md) — provenance + LICENSE pitfalls; рядом extract TA-01…
