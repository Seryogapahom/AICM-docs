...
Обзор blobов на `main` на 2026-09-02. Коммит среза: `3264eaa4376f976b9574ee5210fa3c4d7d815656` (HTF-фильтр к зигзагу). Не канон. Не PREF. Не Foundation.
...
N = **103** (все blobы `main` кроме `.gitignore`, включая этот INDEX и PROVENANCE).
